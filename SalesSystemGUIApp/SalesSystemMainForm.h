...
private: System::Void reporteDeClientesToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		  ReportClientsSales^ reportClientsSales = gcnew ReportClientsSales();
		  reportClientsSales->Show();
}
};
