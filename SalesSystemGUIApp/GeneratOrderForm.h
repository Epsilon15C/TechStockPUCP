...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->txtClientOrder->Margin = System::Windows::Forms::Padding(2);
			...
			this->dgvOrder->Margin = System::Windows::Forms::Padding(2);
			...
			this->btnAddOrder->Margin = System::Windows::Forms::Padding(2);
			...
			this->btnGenerateOrder->Margin = System::Windows::Forms::Padding(2);
			...
			this->btnGenerate->Margin = System::Windows::Forms::Padding(2);
			...
			this->txtRUCOrder->Margin = System::Windows::Forms::Padding(2);
